#!/usr/bin/env python3
"""
Code used to solve Advent of Code 2015 Day 4 exercise 1
Advent of Code 2015, Day 04, Exercise 1
...
def get_hash(file_name):
    ...
    concatenated with the number. If the first five characters of the hash are
